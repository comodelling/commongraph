...
def test_permissions():
    ...
    print(f"Testing 'loggedin' level with anonymous: {check_permission_level('loggedin', anonymous_user)}")
    print(f"Testing 'loggedin' level with regular user: {check_permission_level('loggedin', regular_user)}")
    print(f"Testing 'admin' level with regular user: {check_permission_level('admin', regular_user)}")
    print(f"Testing 'admin' level with admin user: {check_permission_level('admin', admin_user)}")
