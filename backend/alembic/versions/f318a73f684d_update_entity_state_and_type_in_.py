...
def downgrade() -> None:
    ...
    sa.Column('security_question', sa.VARCHAR(), autoincrement=False, nullable=True),
    ...
    op.create_table('graphhistoryevent',
    sa.Column('event_id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('event_type', postgresql.ENUM('create', 'update', 'delete', name='operationtype'), autoincrement=False, nullable=False),
    sa.Column('username', sa.VARCHAR(), autoincrement=False, nullable=False),
