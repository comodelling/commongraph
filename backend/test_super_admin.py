...
def test_user_models():
    ...
    print(f"✅ UserCreate: {user_create.username}, super_admin: {user_create.is_super_admin}")
    ...
    print(f"✅ UserRead: {user_read.username}, admin: {user_read.is_admin}, super_admin: {user_read.is_super_admin}")
